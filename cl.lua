...
RegisterKeyMapping('Emylspd', 'Ouvrir le menu L.S.P.D', 'keyboard', 'F6')
...
RegisterCommand('Emylspd', function()
    ...
    options = {
        {
          ...
          onSelect = function()
            ...
            if closestPlayer ~= -1 and closestDistance <= 3.0 then
                TriggerServerEvent('lspd:handcuff', GetPlayerServerId(closestPlayer))
        ...
        },
        {
          ...
          onSelect = function()
            ...
            local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()            
            if closestPlayer ~= -1 and closestDistance <= 3.0 then
                TriggerServerEvent('lspd:drag', GetPlayerServerId(closestPlayer))
            end
          end,
        },
        {
        ...
        },
        {
          ...
          onSelect = function()
                ...
                local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
                if closestPlayer ~= -1 and closestDistance <= 3.0 then
					TriggerServerEvent('lspd:putInVehicle', GetPlayerServerId(closestPlayer))
                else
        ...
        },
        {
          ...
          onSelect = function()
                ...
                local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
                if closestPlayer ~= -1 and closestDistance <= 3.0 then
                    TriggerServerEvent('lspd:OutVehicle', GetPlayerServerId(closestPlayer))
                else
                    ESX.ShowNotification('Aucune personne proche')
                end
          end,
...
AddEventHandler('tp:openmenu', function()
    exports.ox_lib:showContext('tplspd')
end)
    ...
    options = {
        {
            ...
            onSelect = function()
				...
				TriggerServerEvent('hlspd:Ouvert')
        ...
        },
        {
            ...
            onSelect = function()
                ...
                TriggerServerEvent('hlspd:Fermer') 
...
RegisterNetEvent('lspd:armory')
AddEventHandler('lspd:armory', function()
	if ESX.PlayerData.job and ESX.PlayerData.job.name == 'lspd' then
    ...
    options = {
        {
            ...
            onSelect = function()
                --ESX.ShowNotification("~y~ca fonctionne")  				
				--exports["WaveShield"]:TriggerServerEvent('hlspd:addarmes')
				TriggerServerEvent('hlspd:addarmes')
        ...
        },
        {
            ...
            onSelect = function()
                --ESX.ShowNotification("~y~ca fonctionne") 
                --exports["WaveShield"]:TriggerServerEvent('hlspd:rendarmes') 
                TriggerServerEvent('hlspd:rendarmes') 
...
AddEventHandler('lspd:handcuff', function()
...
AddEventHandler('lspd:putInVehicle', function()
...
AddEventHandler('lspd:OutVehicle', function()
    local plyPed = PlayerPedId()
...
AddEventHandler('lspd:drag', function(copId)
	if isHandcuffed then
