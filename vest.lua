...
RegisterCommand('Emyhelmetlspd', function()
...
RegisterNetEvent('lspd:vestmenu')
AddEventHandler('lspd:vestmenu', function(type, data)
    if ESX.PlayerData.job and ESX.PlayerData.job.name == 'lspd' then        
        exports.ox_lib:showContext('vestlspd')
    else
